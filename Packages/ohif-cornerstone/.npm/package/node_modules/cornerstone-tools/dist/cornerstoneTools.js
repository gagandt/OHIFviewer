...
function onImageRendered(e) {
  ...
  function textBoxText(data) {
    ...
    if (meanStdDev && meanStdDev.mean) {
      ...
      var cor1 = '( ' + numberWithCommas(cx1) + ' , ' + numberWithCommas(cy1) + ' ) : Top Left';
      var cor2 = '( ' + numberWithCommas(cx2) + ' , ' + numberWithCommas(cy1) + ' ) : Top Right';
      var cor3 = '( ' + numberWithCommas(cx1) + ' , ' + numberWithCommas(cy2) + ' ) : Bottom Left';
      var cor4 = '( ' + numberWithCommas(cx2) + ' , ' + numberWithCommas(cy2) + ' ) : Bottom Right';
