/*! cornerstone-tools - 2.4.0 - 2018-10-25 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
/******/ 	var hotCurrentHash = "4ae613a7a980e43aeebe"; // eslint-disable-line no-unused-vars
...
function onImageRendered(e) {
  ...
  function textBoxText(data) {
    ...
    if (meanStdDev && meanStdDev.mean) {
      ...
      // Create a line of text to display the standard deviation and any units that were specified (i.e. HU)
      var stdDevText = 'StdDev: ' + numberWithCommas(meanStdDev.stdDev.toFixed(2)) + moSuffix;
      // Creating a line of text to show the co-ordinates
      

      var cx1 = (data.handles.start.x.toFixed(2));
      var cx2 = Math.round(data.handles.end.x);
      var cy1 = Math.round(data.handles.start.y);
      var cy2 = Math.round(data.handles.end.y);

      var cor1 = 'Co-ordinate 1: ( ' + numberWithCommas(cx1) + ' , ' + numberWithCommas(cy1) + ' )';
      var cor2 = 'Co-ordinate 2: ( ' + numberWithCommas(cx2) + ' , ' + numberWithCommas(cy1) + ' )';
      var cor3 = 'Co-ordinate 3: ( ' + numberWithCommas(cx1) + ' , ' + numberWithCommas(cy2) + ' )';
      var cor4 = 'Co-ordinate 4: ( ' + numberWithCommas(cx2) + ' , ' + numberWithCommas(cy2) + ' )';
